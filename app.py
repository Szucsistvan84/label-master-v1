...
def parse_interfood_pdf(pdf_file):
    ...
    with pdfplumber.open(pdf_file) as pdf:
        ...
        v_lines = [c(0), c(5.5), c(21.5), c(39.5), c(47.3072892), c(52), c(82.5), c(88)]
        ...
        for pg in pdf.pages:
            ...
            for i, anchor in enumerate(anchors):
                ...
                if id_match:
                    ...
                    x40 = (40 / 88) * W
                    x47_3072892 = (47.3072892 / 88) * W      # Balra toltuk 1 egységgel, hogy a '20/' kiessen a névből
                    x52_5 = (52.5 / 88) * W

                    # --- 1. ÜGYINTÉZŐ NEVE (x40 - x47) ---
                    name_words = [w for w in row_words if x40 <= (w['x0'] + w['x1'])/2 < x47_3072892]
                    ...
                    tel_money_words = [w for w in row_words if x47_3072892 <= (w['x0'] + w['x1'])/2 < x52_5]
