...
st.set_page_config(page_title="Interfood v199.3", layout="wide")
...
def create_manifest_pdf(df, fn):
    ...
    for p_idx in range(total_p):
        ...
        # Táblázat adatai
        data = [["SOR", "NÉV / CÍM", "TEL", "RENDELÉS", "DB"]]
