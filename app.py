...
def custom_round(amount):
    """5 Ft-os kerekítési szabály"""
    rounded = 5 * round(amount / 5)
    return rounded

# --- ADATFELDOLGOZÁS (BEVÁLT v203.46+ LOGIKA) ---
...
# --- PDF GENERÁLÁS (JAVÍTOTT OLDALSZÁM ÉS MARKETING) ---
