...
st.set_page_config(page_title="Interfood v198.0 - Final Design", layout="wide")
...
st.title(f"🏷️ Hétvégi Összevont Etikett v198")
...
if st.session_state.get('mdf') is not None:
    ...
    st.download_button("📥 3x7-es PDF Letöltése", pdf, "interfood_v198.pdf", "application/pdf", use_container_width=True)
